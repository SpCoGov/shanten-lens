                ...
                <div className="fuse-grid">
                    <section className="panel">
                        ...
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                            <Trans i18nKey="fuse.section_shop_guard_desc"/>
                        </p>
                    ...
                    <section className="panel">
                        <div className="panel-title">{t("fuse.section_switch_guard_title")}</div>
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                            <Trans i18nKey="fuse.section_switch_guard_desc"/>
                        </p>
                        ...
                        <label className="row" style={{gridTemplateColumns: "auto 1fr"}}>
                            <input
                                className="form-checkbox"
                                type="checkbox"
                                checked={config.enable_ting_ready_skip_guard !== false}
                                onChange={(e) => patchFuseConfig({enable_ting_ready_skip_guard: e.target.checked})}
                            />
                    ...
                    <section className="panel">
                        ...
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                            <Trans i18nKey="fuse.section_conduction_desc"/>
                        </p>
                        ...
                        <label className="row" style={{gridTemplateColumns: "auto 1fr", marginBottom: 10}}>
                            ...
                            />
                            <span>
                                <Trans i18nKey="fuse.toggle_conduction"/>
                            </span>
                        </label>
                        ...
                        <div className="row" style={{gridTemplateColumns: "auto auto 1fr", alignItems: "center"}}>
                            <span className="hint" style={{color: "var(--color-text)"}}>
                                <Trans i18nKey="fuse.label_conduction_threshold"/>
                            </span>
                            <input
                            ...
                            />
                            <span className="hint">
                                <Trans i18nKey="fuse.hint_conduction_threshold"/>
                            </span>
                        </div>
                    </section>
                    ...
                    <section className="panel">
                        <div className="panel-title">
                            <Trans i18nKey="fuse.section_badge_guard_title"/>
                        </div>
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                            <Trans i18nKey="fuse.section_badge_guard_desc"/>
                        </p>
                        ...
                        <label className="row" style={{gridTemplateColumns: "auto 1fr"}}>
                            ...
                            />
                            <span>
                                <Trans i18nKey="fuse.toggle_badge_guard"/>
                            </span>
                        </label>
                    </section>
                    ...
                    <section className="panel">
                        ...
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                            <Trans i18nKey="fuse.section_kavi_plus_desc"/>
                        </p>
                        ...
                        <label className="row" style={{gridTemplateColumns: "auto 1fr"}}>
                            ...
                            />
                            <span>
                                <Trans i18nKey="fuse.toggle_kavi_plus"/>
                            </span>
                        </label>
                    </section>
                    ...
                    <section className="panel">
                        <div className="panel-title">
                            <Trans i18nKey="fuse.section_hanabi_win_title"/>
                        </div>
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                            <Trans i18nKey="fuse.section_hanabi_win_desc"/>
                        </p>
                        ...
                        <label className="row" style={{gridTemplateColumns: "auto 1fr"}}>
                            <input
                                className="form-checkbox"
                                type="checkbox"
                                checked={Boolean(config.enable_hanabi_win_guard)}
                                onChange={(e) => patchFuseConfig({enable_hanabi_win_guard: e.target.checked})}
                            />
                            <span>
                                <Trans i18nKey="fuse.toggle_hanabi_win_guard"/>
                            </span>
                        </label>
                    </section>
                    ...
                    <section className="panel">
                        <div className="panel-title">
                            <Trans i18nKey="fuse.section_exit_life_title"/>
                        </div>
                        <p className="hint" style={{marginTop: 0, lineHeight: 1.5}}>
                        ...
                        <label className="row" style={{gridTemplateColumns: "auto 1fr"}}>
                            ...
                            />
                            <span>
                                <Trans i18nKey="fuse.toggle_exit_life"/>
                            </span>
                        </label>
                    </section>
                </div>
